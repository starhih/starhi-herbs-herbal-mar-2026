/**
 * Lightweight category list for Navbar and Footer.
 * Kept separate from the main data file to avoid bundling 645KB into client JS.
 */
export const navCategories = [
  { name: 'Standardized Herbal Extracts', slug: 'standardized-extracts' },
