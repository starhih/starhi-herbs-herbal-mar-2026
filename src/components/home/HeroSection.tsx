        ...
        {loadVideo && (
          <div className="youtube-container animate-fade-in transition-opacity duration-1000">
            <div className="youtube-video">
              <iframe
                src="https://www.youtube.com/embed/xEBUvF_oKKs?autoplay=1&mute=1&loop=1&controls=0&showinfo=0&rel=0&iv_load_policy=3&playlist=xEBUvF_oKKs&modestbranding=1&enablejsapi=1&disablekb=1&fs=0&color=white&playsinline=1&origin=https://starhiherbs.com&autohide=1&version=3"
